...
static const int64_t nTargetTimespan = 60 * 60;  // Aprilcoin - every hour
unsigned int nTargetSpacing = 1 * 40; // Aprilcoin - 40 seconds
...
unsigned int nStakeMinAge = 24 * 60 * 60; // Aprilcoin - 24 hours
unsigned int nStakeMaxAge = 30 * 24 * 60 * 60; // Aprilcoin - 30 days
unsigned int nModifierInterval = 10 * 60; // Aprilcoin - time to elapse before new modifier is computed
...
const string strMessageMagic = "Aprilcoin Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Aprilcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
